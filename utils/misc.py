...
class StreamToLoguru:
    ...
    def isatty(self):
        """
        Pretend to be a stream and answer truthfully that we are not a tty.
        Wandb and other libraries use this to determine whether to print
        control characters (like for progress bars).
        """
        return False
